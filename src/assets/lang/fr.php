...
// LES PAGES SERVICES
$meta['contact-1'][0] = "Contact - $namebase";
$meta['contact-1'][1] = "Contact";
$meta['contact-1'][2] = "$keywordsbase, contact";

$meta['contact-2'][0] = "Contact - $namebase";
$meta['contact-2'][1] = "Contact";
$meta['contact-2'][2] = "$keywordsbase, contact";

$meta['contact-3'][0] = "Contact - $namebase";
$meta['contact-3'][1] = "Contact";
$meta['contact-3'][2] = "$keywordsbase, contact";

$meta['contact-4'][0] = "Contact - $namebase";
$meta['contact-4'][1] = "Contact";
$meta['contact-4'][2] = "$keywordsbase, contact";
